...
python3 batch_evaluation/batch_dpa_certify.py --evaluations=$eval --num_classes=$num_classes --batch_size=$batch_size --from_idx=0 --num_batches=$num_batches_1 --k_poisons $k_poison --dataset=$dataset > "${output}_dpa_1.log" 2>&1 &
echo "Starting script with batch size $batch_size and $num_batches_2 batches from $part1"
python3 batch_evaluation/batch_dpa_certify.py --evaluations=$eval --num_classes=$num_classes --batch_size=$batch_size --from_idx=$part1 --num_batches=$num_batches_2 --k_poisons $k_poison --dataset=$dataset > "${output}_dpa_2.log" 2>&1 &
wait

# Compute DPA+ROE batch certificates in parallel
echo "Computing DPA+ROE batch certificates"
echo "Starting script with batch size $batch_size and $num_batches_1 batches from 0"
python3 batch_evaluation/batch_dpa_roe_certify.py --evaluations=$eval --num_classes=$num_classes --batch_size=$batch_size --from_idx=0 --num_batches=$num_batches_1 --k_poisons $k_poison --dataset=$dataset > "${output}_dpa_roe_1.log" 2>&1 &
echo "Starting script with batch size $batch_size and $num_batches_2 batches from $part1"
python3 batch_evaluation/batch_dpa_roe_certify.py --evaluations=$eval --num_classes=$num_classes --batch_size=$batch_size --from_idx=$part1 --num_batches=$num_batches_2 --k_poisons $k_poison --dataset=$dataset > "${output}_dpa_roe_2.log" 2>&1 &
wait
